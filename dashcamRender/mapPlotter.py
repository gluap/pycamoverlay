...
class mapDisplay:
    ...
    def draw(self,frame):
        print "should draw"
class mapPlotter:
    def __init__(self,mapfile='osmt.xml',map_output='mymap.png',latLonWidth=.025,centerLat=49.88,centerLon=8.67,size=4*1024):
        ...
        bbox_latlon=(mapnik.Envelope( centerLon-latLonWidth,centerLat-latLonWidth,centerLon+latLonWidth,centerLat +latLonWidth))
